...
export class LayoutService {
    ...
    getClass() {
        if (this.platforms.indexOf("desktop")) {
            return " tablet";
        }
        ...
        // Catch all
        console.log("Layout class can't be determined!");
        return " tablet";

    }

    isPhone() : boolean {
        let result = this.platforms.indexOf("tablet") < 0 &&
                     this.platforms.indexOf("desktop") < 0;
        return result;
    }
}