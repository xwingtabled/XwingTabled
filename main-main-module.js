...
/* harmony import */ var _services_xwing_state_service__WEBPACK_IMPORTED_MODULE_8__ = __webpack_require__(/*! ../services/xwing-state.service */ "./src/app/services/xwing-state.service.ts");
/* harmony import */ var _services_xwing_import_service__WEBPACK_IMPORTED_MODULE_9__ = __webpack_require__(/*! ../services/xwing-import.service */ "./src/app/services/xwing-import.service.ts");
var __decorate = (undefined && undefined.__decorate) || function (decorators, target, key, desc) {
    var c = arguments.length, r = c < 3 ? target : desc === null ? desc = Object.getOwnPropertyDescriptor(target, key) : desc, d;
    if (typeof Reflect === "object" && typeof Reflect.decorate === "function") r = Reflect.decorate(decorators, target, key, desc);
    else for (var i = decorators.length - 1; i >= 0; i--) if (d = decorators[i]) r = (c < 3 ? d(r) : c > 3 ? d(target, key, r) : d(target, key)) || r;
...
var MainPage = /** @class */ (function () {
    function MainPage(modalController, dataService, router, platform, popoverController, events, alertController, ngZone, toastController, storage, http, loadingCtrl, state, importService) {
                    ...
                    case 0: return [4 /*yield*/, this.alertController.create({
                            ...
                            buttons: [
                                { text: 'OK',
                                    handler: function () {
                                        _this.ngZone.run(function () {
                                            _this.state.rechargeAllRecurring();
                                        });
                                    }
                                },
                                { text: 'Cancel',
    ...
    MainPage.prototype.presentXwsModal = function () {
        return __awaiter(this, void 0, void 0, function () {
            var modal, data, url, squadron, e_1, toast;
            var _this = this;
            return __generator(this, function (_a) {
                switch (_a.label) {
                    ...
                    case 4:
                        _a.trys.push([4, 5, , 7]);
                        if (data.ffg) {
                            url = "https://squadbuilder.fantasyflightgames.com/api/squads/" + data.ffg + "/";
                            this.http.get(url).subscribe(function (data) {
                                _this.state.setSquadron(_this.importService.processFFG(data));
    ...
    MainPage = __decorate([
        ...
        __metadata("design:paramtypes", [_ionic_angular__WEBPACK_IMPORTED_MODULE_1__["ModalController"],
            ...
            _services_xwing_state_service__WEBPACK_IMPORTED_MODULE_8__["XwingStateService"],
            _services_xwing_import_service__WEBPACK_IMPORTED_MODULE_9__["XwingImportService"]])
    ], MainPage);
    return MainPage;
}());
